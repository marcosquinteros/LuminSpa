...
var context2 = React39.createContext(null);
...
function NoopTransition({
  ...
  const child = (0, import_react30.cloneElement)(children, {
    ref: combinedRef
  });
  if (inProp)
    return child;
...
var Modal = (0, import_react32.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime70.jsx)(import_jsx_runtime71.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime72.jsxs)(import_jsx_runtime71.Fragment, {
...
function createButton(name, defaultValue, label = name) {
  const Button2 = React104.forwardRef(({
    children,
    ...props
