            ...
            <div className="row gy-5"> 
                  <div className="col-lg-6">
                    <div>
                        ...
                        <input  value={name} onChange={e=>setName(e.target.value)} placeholder="" type="text" name="nombre" id="input"className='form-control' />
                        </div>
                    </div>
                    ...
                    <div className='col-lg-12'>
                        ...
                        <input  value={email} onChange={e=>setEmail(e.target.value)} id="input" placeholder="" type="email" name="user_email" className='form-control' />
                    </div>

                    <div>    
                    <div className='col-lg-12'>
                        <p className="texto-register-login"> Usuario </p>
                        <input  value={id} onChange={e=>setId(e.target.value)}id="input" placeholder='' type="text" name="username" className='form-control '/>                </div>
                    </div>
                    <div className='col-lg-12'>
                    ...
                    <div className='col-lg-6'>
                        ...
                        <input  value={pass2} onChange={e=>setPass2(e.target.value)} id="input" placeholder='' type="text" name="password2" className='form-control '/>                </div>
                    </div>
                    <div className="col-lg-6">
