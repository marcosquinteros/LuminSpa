            ...
            <form onSubmit={validLogin} className="contenedor-register-login">           
              ...
              <div className="col-lg-6">
                <div className="col-lg-12">
                  ...
                  <input value={username} onChange={e=>setUsername(e.target.value)} id="input" type="text" className='form-control' />
                </div>
                <div className='col-lg-12'>
                  <p className="texto-register-login"> Contraseña </p>
                  <input value={password} onChange={e=>setPassword(e.target.value)} id="input" type="password"  className='form-control' />
                  <div className="col-lg-6">
